class UserInterface {
  ...
  _setEqualizerPauseState() {
    ...
    equalizer.setAttribute('src', 'assets/eq_pause.png');
  }
  ...
  _setEqualizerPlayState() {
    let equalizer = this._equalizer;
    equalizer.setAttribute('src', 'assets/eq_play.gif');
  }
...
let settings = {
  ...
  song: 'Set You Free',
  artist: 'Omari Harebin',
  audioFilePath: 'https://static1.squarespace.com/static/63db120d97415d651432f8f1/63e56f54b0934a6b31fcde18/63e56f970104a06f430997e6/1675980703336/script+it+then+i+live+it.mp3'
};
